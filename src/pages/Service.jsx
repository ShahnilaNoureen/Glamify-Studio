...
import title4 from "../assets/title4.avif";
    ...
    <>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center">
        <motion.div
          ...
          className="p-5 md:p-8 lg:p-14 space-y-8 md:space-y-10"
        >
          <p className="text-black max-w-sm text-base md:text-lg">We provide a variety of popular services but get in touch with us if you want to discuss something outside the standard price list.</p>
          <div className="space-y-4 font-medium border-t border-black pt-5">
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Haircut (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$60</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Blow Dry (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$40</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Styling (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$40</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Spa Treatment (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$50</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Single Color (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$85</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Partial Highlights (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$130</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Full Highlights (90 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$170</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Neck/Beard Trim(20 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$15</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Painting/Balayage (140 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$170</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Color Correction (40 min+)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$40</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Creative Colors (50 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$90</span></div>
          </div>
          <button
            onClick={() => window.open("https://www.fresha.com/for-business", "_blank", "noopener,noreferrer")}
            className="border-2 md:border-4 border-black px-6 md:px-10 py-3 md:py-4 font-black uppercase tracking-widest hover:bg-black hover:text-white transition-colors"
          >
            Book Now
          </button>
        </motion.div>
...
>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center h-auto md:h-170">
        ...
        <motion.div
          ...
          className="p-5 md:p-8 lg:p-14 space-y-8 md:space-y-10 order-1 md:order-2"
        >
          <p className="text-black max-w-sm text-base md:text-lg">We provide a variety of popular services but get in touch with us if you want to discuss something outside the standard price list.</p>
          <div className="space-y-4 font-medium border-t border-black pt-5">
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Classic Manicure (30 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$30</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">French Manicure (45 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$40</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Gel Nails (50 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$50</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Gel Nails Art (70 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$70</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Nail Repair</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$10</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Hand Spa</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$15</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Classic Pedicure (60 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$55</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">French Pedicure (60 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$65</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Foot Spa</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$20</span></div>
          </div>
          <button
            onClick={() => window.open("https://www.fresha.com/for-business", "_blank", "noopener,noreferrer")}
            className="border-2 md:border-4 border-black px-6 md:px-10 py-3 md:py-4 font-black uppercase tracking-widest hover:bg-black hover:text-white transition-colors"
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center">
        ...
        >
          <p className="text-black max-w-sm text-base md:text-lg">We provide a variety of popular services but get in touch with us if you want to discuss something outside the standard price list.</p>
          <div className="space-y-4 font-medium border-t border-black pt-5">
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Quick Fix Makeup (15 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$25</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Classic Makeup (40 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$40</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Art Makeup (60 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$50</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Bridal Makeup (110 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$70</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Lash Extension (40 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$40</span></div>
            <div className="flex justify-between items-end"><span className="text-black text-sm md:text-base">Lash Extension Correction (20 min)</span><span className="border-b border-dotted border-black grow mx-2 mb-1"></span><span className="text-sm md:text-base">$25</span></div>
          </div>
          <button
            onClick={() => window.open("https://www.fresha.com/for-business", "_blank", "noopener,noreferrer")}
            className="border-2 md:border-4 border-black px-6 md:px-10 py-3 md:py-4 font-black uppercase tracking-widest hover:bg-black hover:text-white transition-colors"
      ...
      <section
        className="relative bg-black py-12 md:py-24 px-4 md:px-6 text-center flex flex-col items-center justify-center"
        style={{
      ...
      >
        <div className="w-full max-w-7xl h-auto px-4 md:px-6 lg:px-20 py-12 md:py-20 bg-[#f6ebe3]">
          <motion.div
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.3 }}
            ...
            className="inline-block border-y border-black py-1 mt-0 md:mt-5 mb-5"
          >
          ...
          >
            <h2 className="relative z-10 text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-black uppercase tracking-tighter text-black">
      ...
      <section className="relative bg-white px-4 md:px-6 text-center flex flex-col items-center justify-center py-12 md:py-24">
        <motion.div
          initial={{ opacity: 0, y: 100 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.3 }}
      ...
      <section className="relative min-h-40 flex items-center justify-center py-12 md:py-10 px-4 md:px-6 overflow-hidden font-sans bg-white">
      ...
      {/* Contact Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-[80vh] md:min-h-screen font-sans border-t border-black">
      ...
      <motion.section
        ...
        className="relative min-h-40 flex flex-col items-center justify-center text-center py-12 md:py-20 px-4 md:px-6 overflow-hidden font-sans bg-white"
      >
